  ...
  itemListElement: [
    {
      ...
      item: {
        ...
        offers: { "@type": "Offer", priceCurrency: "EUR", price: "2500",
    ...
    },
    {
      ...
      item: {
        ...
        description: "Web corporativa, landing page o panel de administración.",
    ...
    },
    {
      ...
      item: {
        ...
        description: "App móvil + web + backend + API.",
        offers: { "@type": "Offer", priceCurrency: "EUR", price: "4500",
          priceSpecification: { "@type": "UnitPriceSpecification", priceType: "MinimumAdvertisedPrice" } },
      },
    },
    {
      ...
      item: {
        ...
        offers: { "@type": "Offer", priceCurrency: "EUR", price: "300",
