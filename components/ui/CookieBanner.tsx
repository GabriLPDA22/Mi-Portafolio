    ...
    <AnimatePresence>
      {isVisible && (
        <m.div
          ...
          className="fixed bottom-0 left-0 right-0 z-50 w-full max-w-[100vw] border-t border-white/[0.1] bg-noir/95 backdrop-blur-xl overflow-hidden"
        >
          <div className="w-full px-3 py-2.5 sm:container-main sm:py-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
              ...
              <div className="flex flex-1 items-start gap-1.5 min-w-0 sm:gap-2">
                <Cookie className="h-3.5 w-3.5 flex-shrink-0 text-acid mt-0.5 sm:h-5 sm:w-5" />
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-1 text-[10px] text-white/50 sm:mt-2 sm:text-[12px]">
                    ...
                    <Link
                      href="/privacidad"
                      className="text-acid underline hover:text-acid-light transition-colors break-words"
                    >
              ...
              <div className="flex items-center gap-1.5 sm:gap-3 sm:flex-shrink-0">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-acid px-3.5 py-1.5 text-[11px] font-bold text-noir transition-all duration-300 hover:bg-acid-light hover:shadow-lg hover:shadow-acid/25 sm:px-6 sm:py-2.5 sm:text-[13px] flex-shrink-0 whitespace-nowrap"
                >
