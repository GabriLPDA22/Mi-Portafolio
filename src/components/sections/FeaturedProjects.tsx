...
/** Equivalente al `fill` de next/image: la imagen ocupa todo su contenedor posicionado. */
const FILL_STYLE = { position: "absolute", inset: 0, width: "100%", height: "100%" } as const;
