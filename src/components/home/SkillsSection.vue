...
<template>
  <section id="skills" class="py-24 relative overflow-hidden">
    ...
    <div class="absolute -bottom-[300px] -right-[300px] w-[600px] h-[600px] rounded-full bg-indigo-600/10 blur-3xl z-0">
    </div>
        ...
        <div class="space-y-8 fade-in-element">
          ...
          <div class="text-center mt-8 pt-6 border-t border-zinc-800">
            <a href="/cv.pdf" download="Gabriel_Saiz_CV.pdf" target="_blank"
              class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300">
