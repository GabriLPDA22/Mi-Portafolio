<template>
    <footer class="relative mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0 bg-zinc-950/80 z-0"></div>
        <div class="absolute h-px top-0 inset-x-0 bg-gradient-to-r from-transparent via-indigo-500 to-transparent">
        </div>
        ...
        <div class="container mx-auto px-6 py-12 relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex items-center space-x-2 text-zinc-500 text-sm">
                    <span>Hecho con</span>
