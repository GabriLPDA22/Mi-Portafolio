  ...
  <footer class="footer">
    ...
    <div class="footer-container">
      ...
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          <div class="brand-logo">
            ...
            <span class="logo-text">Gabriel Saiz</span>
          </div>

          <p class="brand-description">
            Desarrollador Full Stack freelance especializado en Vue.js, React
            Native, .NET y arquitecturas cloud. Creando productos digitales de
            calidad.
          </p>
        ...
        <div class="footer-section">
          ...
          <ul class="footer-contact">
            ...
            <li class="contact-item">
              ...
              <a href="tel:+34663941885">+34 663 941 885</a>
            </li>
            <li class="contact-item">
              <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
      ...
      <div class="footer-bottom">
        <p class="copyright">
          &copy; {{ new Date().getFullYear() }} Gabriel Saiz. Todos los derechos
          reservados.
        </p>

        <div class="footer-meta">
          <router-link to="/privacy-policy" class="meta-link">
...
.footer-bg {
  position: absolute;
  inset: 0;
  background: linear-gradient(to bottom, transparent, rgba(255, 107, 53, 0.03));
  pointer-events: none;
}
